    ...
    @if (auth()->user()->isSupporter())
        ...
        >
            ...
            <div class="px-4 pt-4 pb-2 flex items-center justify-between">
                ...
                >
                    <p class="text-sm font-medium" style="color:#C9D1D9;">Collections</p>
                    <svg
                        :class="open ? 'rotate-180' : ''"
                        class="transition-transform ml-auto"
                        width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#3d4451" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"
            ...
            <div x-show="open" x-collapse>
                ...
                @if ($showForm)
                    <div class="px-4 pb-3 flex gap-2">
                        <input
                            ...
                            maxlength="60"
                            class="flex-1 rounded-lg px-2.5 py-1.5 text-xs focus:outline-none"
                ...
                @if ($this->collections->isEmpty() && ! $showForm)
                    <p class="px-4 pb-4 text-xs leading-snug" style="color:#3d4451;">Create your first collection to group rooms you love.</p>
                @else
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <svg
                                            ...
                                            width="8" height="8" viewBox="0 0 24 24" fill="none" stroke="#3d4451" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"
                                        ><polyline points="9 18 15 12 9 6"/></svg>
                                        <span x-show="!renaming" class="text-xs truncate font-medium" style="color:#C9D1D9;">{{ $collection->name }}</span>
                                        <span class="text-xs flex-none ml-auto" style="color:#3d4451;">{{ $liveItems->count() }}</span>
                                    </button>
                                ...
                                <div x-show="renaming" class="px-2.5 pb-2 flex gap-2" style="display:none;">
                                    <input
                                        ...
                                        class="rename-input flex-1 rounded-lg px-2 py-1 text-xs focus:outline-none"
                                        style="background:#161B22;border:1px solid #30363D;color:#E6EDF3;"
                                        maxlength="60"
                                    >
                                    <button
                                ...
                                <div x-show="expanded" class="pl-5 pr-2 pb-1.5 space-y-0.5" style="display:none;">
                                    @if ($liveItems->isEmpty())
                                        <p class="text-xs py-1" style="color:#3d4451;">No rooms here yet.</p>
                                    @else
