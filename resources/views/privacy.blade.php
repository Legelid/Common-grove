...
<head>
    ...
    <title>Privacy Policy — CommonGround</title>
    @livewireStyles
...
<body class="bg-[#0D1117] antialiased pt-16 min-h-full">
    ...
    <main class="flex items-center justify-center py-20 px-6">
        <div class="w-full max-w-2xl bg-[#161B22] border border-[#30363D] rounded-2xl p-10">
            <h1 class="text-2xl font-bold text-[#E6EDF3] mb-4">Privacy Policy</h1>
            <p class="text-[#8B949E] mb-8">This privacy policy is being finalised. Check back soon.</p>
